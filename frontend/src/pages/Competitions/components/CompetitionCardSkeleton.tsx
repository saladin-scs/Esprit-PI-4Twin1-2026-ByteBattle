...
function CompetitionCardSkeletonComponent() {
  return (
    <div
      className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-5 animate-pulse"
      role="status"
    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <div className="h-4 w-full rounded bg-gray-200 dark:bg-gray-700/80" />
          <div className="h-4 w-2/3 rounded bg-gray-200 dark:bg-gray-700/80" />
          <div className="h-8 w-64 rounded-lg bg-gray-300 dark:bg-gray-700" />
        ...
        <div className="h-5 w-12 rounded bg-gray-300 dark:bg-gray-700 shrink-0" />
      </div>
    </div>
  );
}
